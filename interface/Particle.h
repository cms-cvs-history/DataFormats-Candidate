...
namespace reco {
  ...
  public:
    ...
    /// set 4-momentum
    void setP4( const LorentzVector & p4 ) { hasCacheSet_ = false; p4_ = p4; }
    void setP4( const PolarLorentzVector & p4 ) { hasCacheSet_ = false; p4_ = p4; }
    void setPz( double pz ) { hasCacheSet_ = false; p4_.SetPz(pz); }
